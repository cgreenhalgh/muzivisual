 ...
 *
 * ```js
 *   var MuziVisualDev = angular.module('MuziVisualDev', ['MuziVisual', 'ngMockE2E']);
 *   MuziVisualDev.run(function($httpBackend) {
 ...
 *
 * ## Example
 * <example name="httpbackend-e2e-testing" module="MuziVisualE2E" deps="angular-mocks.js">
 * <file name="app.js">
 *   var MuziVisual = angular.module('MuziVisual', []);
 *
 *   MuziVisual.controller('MainCtrl', function MainCtrl($http) {
 *     var ctrl = this;
 *
 *     ctrl.phones = [];
 *     ctrl.newPhone = {
 ...
 * </file>
 * <file name="e2e.js">
 *   var MuziVisualDev = angular.module('MuziVisualE2E', ['MuziVisual', 'ngMockE2E']);
 *
 *   MuziVisualDev.run(function($httpBackend) {
 *     var phones = [{name: 'phone1'}, {name: 'phone2'}];
 *
...
(function(jasmineOrMocha) {
   ...
   * ```js
   *
   *   angular.module('MuziVisuallicationModule', [])
   *       .value('mode', 'app')
   *       .value('version', 'v1.0.1');
   *
   *
   *   describe('MuziVisual', function() {
   *
   *     // You need to load modules that you want to test,
   *     // it loads only the "ng" module by default.
   *     beforeEach(module('MuziVisuallicationModule'));
   *
   *
