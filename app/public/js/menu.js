...
menu.controller('previewCtrl', ['$scope', 'd3Service', 'visualMapBuilder', '$http', '$location', 'mpmLoguse', function ($scope, d3Service, visualMapBuilder, $http, $location, mpmLoguse) {
